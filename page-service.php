        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-7 pl-4">
            <div class="mb-5">
              ...
              <p>
                Все наши проекты создаются креативными веб-дизайнерами, соблюдая все современные тенденции в этой
                сфере. Лучшие специалисты будут создавать продукт для вас.
              </p>
            </div>
            <ul class="about-list">
              <li>
