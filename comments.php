...
<div id="comments" class="comments my-4">
    ...
    'fields'               => [
      ...
      'cookies' => '<div class="comment-form-cookies-consent d-flex col-lg-12">' .
        sprintf( '<input id="wp-comment-cookies-consent" name="wp-comment-cookies-consent" class="mr-3" type="checkbox" value="yes"%s />', @$consent ) . '
    ...
    'logged_in_as'         => '<div class="logged-in-as mb-3 col-lg-12">' .
      sprintf(__('<a href="%1$s" aria-label="Вы вошли как %2$s.">Вы вошли как %2$s</a>. <a href="%3$s">Выйти?</a>'),
